...
<?php 
         //check whether the submit Button is clicked on Not
            ...
            if(isset($_POST['submit']))
            {
                ...
                //check where the user with current id and current password exists or not
                ...
                if($res==true)
                {
                    //check whether data  is available ore not
                    ...
                    if($count==1)
                    {
                        ...
                        if($new_password==$confirm_password)
                        {
                            ...
                            $sql2="UPDATE table_admin SET
                                ...
                                //whether query the query extent or not
                                if($res2==true)
                                {
                                    //display sucess massage
                                ...
                                else
                                {
                                    //display error massage
                                     ...
                                     $_SESSION['change-pwd'] = "<div class='error'>Password change Uuccessfully.</div>";
                                     //redirect the user
                                     header('location:'.SITEURL.'admin/manage-admin.php');
                                }
                        }
